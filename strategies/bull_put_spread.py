...
class Strategy:
    ...
    def build_trade(self, context, width=200, **kwargs):
        ...
        short_strike = find_oi_wall(chain, "PE") or int(context["nifty_price"]) - 100
        long_strike = short_strike - width
        return [
            {
                "symbol": _nearest_symbol(chain, short_strike, "PE"),
                "side": "SELL",
                "qty": qty,
            },
            {
                "symbol": _nearest_symbol(chain, long_strike, "PE"),
                "side": "BUY",
                "qty": qty,
            },
        ]
